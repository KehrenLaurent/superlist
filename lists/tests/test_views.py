...
class ListViewTest(TestCase):
    ...
    def test_uses_list_template(self):
        list_ = List.objects.create()
        response = self.client.get('/lists/{}/'.format(list_.pk))
    ...
    def test_for_invalid_input_nothing_save_to_bd(self):
...
class NewListTest(TestCase):
    ...
    def test_invalid_list_items_arend_saved(self):
    ...
    def test_validation_errors_a_shown_on_home_page(self):
        response = self.client.post('/lists/new', data={'text': ''})
        self.assertContains(response, escape(EMPTY_LIST_ERROR))
...
class NewItemTest(TestCase):
    ...
    def test_redirects_to_list_view(self):
        ...
        response = self.client.post(
            '/lists/{}/'.format(correct_list.pk),
            data={'text': 'A new item for existing list'}
        )

        self.assertRedirects(response, '/lists/{}/'.format(correct_list.pk))
